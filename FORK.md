...
The organization switcher trusts the preflight permission and opens the creation
dialog directly.
...
Only the MIT-licensed core organization permission, preflight, and organization
creation UI paths are changed. The separate license in `ee/LICENSE` still governs
any enterprise code included in or used by the upstream base image, including
production use.
