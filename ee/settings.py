...
REPLAY_VISION_PROVIDER = get_from_env("REPLAY_VISION_PROVIDER", "gemini")
REPLAY_VISION_ANTHROPIC_MODEL = get_from_env("REPLAY_VISION_ANTHROPIC_MODEL", "claude-3-5-sonnet-20241022")
REPLAY_VISION_ANTHROPIC_MAX_FRAMES = get_from_env("REPLAY_VISION_ANTHROPIC_MAX_FRAMES", 20, type_cast=int)
REPLAY_VISION_ANTHROPIC_FRAME_WIDTH = get_from_env("REPLAY_VISION_ANTHROPIC_FRAME_WIDTH", 1024, type_cast=int)
